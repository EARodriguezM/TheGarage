...
SET ANSI_PADDING ON
GO
CREATE TABLE [R-DATA_USER-VEHICLE](
    [RELATION_ID] NVARCHAR(10) NOT NULL,
    [DATA_USER_ID] NVARCHAR(10) NOT NULL,
    [VEHICLE_PLATE] NVARCHAR(10) NOT NULL,
    [STATUS] BIT DEFAULT 1 NOT NULL,
    CONSTRAINT [R-DATA_USER-VEHICLE_PK] PRIMARY KEY ([RELATION_ID]),
    CONSTRAINT [R-DATA_USER-VEHICLE_FK--DATA_USER] FOREIGN KEY ([DATA_USER_ID]) REFERENCES [DATA_USER]([DATA_USER_ID]),
    CONSTRAINT [R-DATA_USER-VEHICLE_FK--VEHICLE] FOREIGN KEY ([VEHICLE_PLATE]) REFERENCES [VEHICLE]([VEHICLE_PLATE]),
    CONSTRAINT [R-DATA_USER-VEHICLE_STATUS_CK] CHECK([STATUS] = 1 OR [STATUS] = 0)
